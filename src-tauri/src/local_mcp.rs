...
use crate::{
    ...
    setup::SetupPatch,
    work_area_planning::{
        CallerAuthority, PrepareMapRequest, PreparePlanRequest, PrepareQuestionsRequest,
        WorkAreaPlanningService,
    },
    work_area_store::{WorkAreaRepository, WorkAreaService},
    work_area_view::{
        context_view, map_view, plan_view, ImprovementPlanView, OperationalMapView,
...
mod tests {
    use super::*;
    use crate::work_area::{QuestionCategory, WorkAreaState, WorkAreaTemplate};
    use std::{
